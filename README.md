...
![Made in](https://img.shields.io/badge/Made%20in-Colombia-yellow)
...
Designed for speed, storytelling, and scalability.

- **Core:** [Next.js 16](https://nextjs.org/) (App Router)
- **Styling:** Tailwind CSS 4 + Framer Motion (Animations)
- **Content:** MDX (For the Journal/Manifesto)
...
## 🚀 Running the "Soul" Locally

1. **Clone the Universe:**

```bash
git clone https://github.com/YOUR_USERNAME/kibo-nexus-web.git
cd kibo-nexus-web
```
...
This repository is **Open Source** because we believe in sharing the blueprint of our legacy.

While the specific financial logic of *Kibo CFO* is private (for security), this Hub is a public declaration of our values. If you want to fix a typo in our manifesto or improve the accessibility of our message, Pull Requests are welcome.
